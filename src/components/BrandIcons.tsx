...
export const SiPhotoshop = (props: IconBaseProps) =>
  GenIcon({
    tag: "svg",
...
export const SiIllustrator = (props: IconBaseProps) =>
  GenIcon({
    tag: "svg",
    attr: { role: "img", viewBox: "0 0 24 24" },
    child: [
...
export const SiAfterEffects = (props: IconBaseProps) =>
  GenIcon({
    tag: "svg",
    attr: { role: "img", viewBox: "0 0 24 24" },
    child: [
...
export const SiPremierePro = (props: IconBaseProps) =>
  GenIcon({
    tag: "svg",
    attr: { role: "img", viewBox: "0 0 24 24" },
    child: [
...
export const SiInDesign = (props: IconBaseProps) =>
  GenIcon({
    tag: "svg",
    attr: { role: "img", viewBox: "0 0 24 24" },
    child: [
...
export const SiAdobeXd = (props: IconBaseProps) =>
  GenIcon({
    tag: "svg",
    attr: { role: "img", viewBox: "0 0 24 24" },
    child: [
...
export const SiCanva = (props: IconBaseProps) =>
  GenIcon({
    tag: "svg",
    attr: { role: "img", viewBox: "0 0 24 24" },
    child: [
...
export const CursorIcon = ({ className, style }: CustomIconProps) => (
...
export const VSCodeIcon = ({ className, style }: CustomIconProps) => (
  <div className={className} style={style}>
    <svg
      width="1em"
      height="1em"
